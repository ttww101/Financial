...
class AASphereView: UIView {
    ...
    func setTagViews(abbs:String?, array: [UIView]) {
    ...
    func setViewWith(abbs:String?, coordinate : AAPoint, at index: Int) {
    ...
    func rotateWith(abbs:String?, translation: CGPoint) {
    ...
    func changeCoordinate(abbs:String?, point: AAPoint) -> CGPoint {
